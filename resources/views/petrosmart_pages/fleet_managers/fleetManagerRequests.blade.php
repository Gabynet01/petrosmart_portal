...
@section('title', 'Petrosmart | Fleet Managers Requests')
        ...
        <nav class="side-navbar box-scroll sidebar-scroll">
            ...
            <ul class="list-unstyled">
                ...
                <li><a href="#dropdown-fleet-tables" aria-expanded="true" data-toggle="collapse" class="active"><i class="ti-id-badge"></i>
                    ...
                    <ul id="dropdown-fleet-tables" class="list-unstyled pt-0">
                        <li><a href="/fleetManagerRequests" class="sub_active">All Requests</a></li>
                    ...
                    <div class="w3-card-2 w3-white panel widget has-shadow">
                        ...
                        <div class="widget-body sliding-tabs">
                            ...
                            <ul class="nav nav-tabs" id="example-one" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="base-tab-pending" data-toggle="tab" href="#tab-pending" role="tab" aria-controls="tab-pending" aria-selected="true">Pending Requests</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="base-tab-approved" data-toggle="tab" href="#tab-approved" role="tab" aria-controls="tab-approved" aria-selected="false">Approved Requests</a>
                                </li>
                            </ul>


                            <div class="tab-content pt-3">
                                <div class="tab-pane fade show active" id="tab-pending" role="tabpanel" aria-labelledby="base-tab-pending">
                                    <!-- Begin Row -->
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="table-responsive">
                                                <table id="pendingRequestsDataTable" style="width:100%" class="table mb-0 table-striped table-hover manage-u-table table-css" role="grid" aria-describedby="sorting-table_info">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting" tabIndex="0" aria-controls="sorting-table" rowSpan="1" colSpan="1">Payment Code
                                                            </th>

                                                            <th class="sorting" tabIndex="0" aria-controls="sorting-table" rowSpan="1" colSpan="1">Amount
                                                            </th>

                                                            <th class="sorting" tabIndex="0" aria-controls="sorting-table" rowSpan="1" colSpan="1">Station Wallet
                                                            </th>

                                                            <th class="sorting" tabIndex="0" aria-controls="sorting-table" rowSpan="1" colSpan="1">Company Wallet
                                                            </th>

                                                            <th class="sorting" tabIndex="0" aria-controls="sorting-table" rowSpan="1" colSpan="1">Approval Status
                                                            </th>
                                ...
                                <div class="tab-pane fade" id="tab-approved" role="tabpanel" aria-labelledby="base-tab-approved">
                                    <!-- Begin Row -->
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="table-responsive">
                                                <table id="approvedRequestsDataTable" style="width:100%" class="table mb-0 table-striped table-hover manage-u-table table-css" role="grid" aria-describedby="sorting-table_info">
                                                    <thead>
                                                        <tr role="row">
                                                            <th class="sorting1" tabIndex="0" aria-controls="sorting-table" rowSpan="1" colSpan="1" aria-label="Form Order Id: activate to sort column ascending" style="width:10px">#
                                                            </th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Add Fleet Manager</h4>
                    ...
                    <form>
                        <div class="form-group row d-flex align-items-center mb-5">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="addFullName" placeholder="Name">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="addPassword" placeholder="Enter a secure password">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <select class="custom-select-roletype form-control select_company_fleet_manager_picker" onchange="getCompanyBranches(this)" data-live-search="true" id="addFleetManagerCompanySelect" name="addFleetManagerCompanySelect">
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <select class="custom-select-roletype form-control" id="addFleetManagerCompanyBranchSelect" name="addFleetManagerCompanyBranchSelect" onchange="getCompanyBranchesDrivers(this)">
                            ...
                            <div class="col-6">
                                <label class="form-control-label">Select Drivers</label>
                                <div class="form-group">
                                    <select class="custom-select-roletype form-control select_fleet_manager_driver_picker" multiple data-live-search="true" id="addFleetManagerDriverSelect" name="addFleetManagerDriverSelect">
                                    </select>
                                </div>
                            </div>
                    ...
                    <form id="editUserForm">
                        <div class="form-group row d-flex align-items-center mb-5">
                            ...
                            <div class="col-6">
                                <label class="form-control-label">Select Company</label>
                                <div class="form-group">
                                    <select class="custom-select-roletype form-control edit_company_fleet_manager_picker" onchange="getCompanyBranches(this)" data-live-search="true" id="editFleetManagerCompanySelect" name="editFleetManagerCompanySelect">
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <label class="form-control-label">Branch</label>
                                <div class="form-group">
                                    <select class="custom-select-roletype form-control" id="editFleetManagerCompanyBranchSelect" name="editFleetManagerCompanyBranchSelect" onchange="getCompanyBranchesDrivers(this)">
                                        <!-- <option value="allBranch">All Branch</option> -->
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <label class="form-control-label">Select Drivers</label>
                                <div class="form-group">
                                    <select class="custom-select-roletype form-control edit_fleet_manager_driver_picker" multiple data-live-search="true" id="editFleetManagerDriverSelect" name="editFleetManagerDriverSelect">
                                    </select>
                                </div>
                            </div>
...
@push('pageScripts')
<script src="{{asset('assets/js/components/manage_fleet_manager_requests.js')}}"></script>
@endpush