...
@section('title', 'Petrosmart | Manage Fleet Managers')
            ...
            <ul class="list-unstyled">
                ...
                <li><a href="#dropdown-fleet-tables" aria-expanded="true" data-toggle="collapse" class="active"><i class="ti-id-badge"></i>
                    ...
                    <ul id="dropdown-fleet-tables" class="list-unstyled pt-0">
                        ...
                        <li><a href="/manageFleetManagers" class="sub_active">Manage Users</a></li>
                    </ul>
                </li>
                @endif
                                ...
                                <table id="appUsersDataTable" style="width:100%" class="table mb-0 table-striped table-hover manage-u-table table-css" role="grid" aria-describedby="sorting-table_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabIndex="0" aria-controls="sorting-table" rowSpan="1" colSpan="1">Mobile Number
                                            </th>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="addMobileNumber" placeholder="Mobile Address">
                                    </div>
                                </div>
                            </div>
...
@push('pageScripts')
<script src="{{asset('assets/js/components/manage_fleet_managers.js')}}"></script>
@endpush