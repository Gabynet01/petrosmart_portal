...
@section('title', 'Petrosmart | Manage OMC Users')
    ...
    <div class="w3-card-2 w3-white panel default-sidebar">
        ...
        <nav class="side-navbar box-scroll sidebar-scroll">
            ...
            <ul class="list-unstyled">
                ...
                <li><a href="#dropdown-tables" aria-expanded="true" data-toggle="collapse" class="active"><i class="ti-world"></i>
                        <span>OMC</span>
                    </a>
                    <ul id="dropdown-tables" class="list-unstyled pt-0">
                        <li><a href="/omcList">All OMC</a></li>
                        <li><a href="/applicationUsers" class="sub_active">Manage Users</a></li>
                    </ul>
                </li>
