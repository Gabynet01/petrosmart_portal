...
@section('title', 'Petrosmart | Manage Company Branches')
    ...
    <div class="w3-card-2 w3-white panel default-sidebar">
        ...
        <nav class="side-navbar box-scroll sidebar-scroll">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    <a href="/companyBranchList" class="active">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="addBranchContact2" placeholder="Enter contact 2">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="editBranchContact2" placeholder="Enter contact 2">
                                    </div>
                                </div>
                            </div>
...
@push('pageScripts')
<script src="{{asset('assets/js/custom/company/branches.js')}}"></script>
@endpush