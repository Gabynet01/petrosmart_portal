    ...
    <div class="w3-card-2 w3-white panel default-sidebar">
        ...
        <nav class="side-navbar box-scroll sidebar-scroll">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    <a href="/companyDriversList" class="active">
                                ...
                                <table id="driversFormDataTable" style="width:100%" class="table mb-0 table-striped table-hover manage-u-table table-css" role="grid" aria-describedby="sorting-table_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabIndex="0" aria-controls="sorting-table" rowSpan="1" colSpan="1">E-mail
                                            </th>
...
@push('pageScripts')
<script src="{{asset('assets/js/custom/company/drivers.js')}}"></script>
@endpush