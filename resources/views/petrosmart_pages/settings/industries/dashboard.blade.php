...
@section('title', 'Petrosmart | Manage Countries')
    ...
    <div class="w3-card-2 w3-white panel default-sidebar">
        ...
        <nav class="side-navbar box-scroll sidebar-scroll">
            ...
            <ul class="list-unstyled">
                ...
                <li><a href="#dropdown-settings-tables" aria-expanded="true" data-toggle="collapse" class="active"><i class="ti-settings"></i>
                        <span>Settings</span>
                    </a>
                    <ul id="dropdown-settings-tables" class="list-unstyled pt-0">
                        <li><a href="/countryList">Countries</a></li>
                        <li><a href="/industryList"  class="sub_active">Industries</a></li>
                    </ul>
                </li>
                @endif
...
@push('pageScripts')
<script src="{{asset('assets/js/custom/settings/industries.js')}}"></script>
@endpush